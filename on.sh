...
echo ""
echo ""
mkdir /sdcard/Android/data/com.wolfbhai.shell
cd /sdcard/Android/data/com.wolfbhai.shell
mkdir ori mod
mv /data/data/com.tencent.ig/lib/libtersafe.so /sdcard/Android/data/com.wolfbhai.shell/mod
cp -R /sdcard/Android/data/com.wolfbhai.shell/mod/libtersafe.so /sdcard/Android/data/com.wolfbhai.shell/ori

echo " ▒█░░▒█ ▒█▀▀▀█ ▒█░░░ ▒█▀▀▀ ▒█▀▀█ ▒█░▒█ ░█▀▀█ ▀█▀ "
echo " ▒█▒█▒█ ▒█░░▒█ ▒█░░░ ▒█▀▀▀ ▒█▀▀▄ ▒█▀▀█ ▒█▄▄█ ▒█░ "
echo " ▒█▄▀▄█ ▒█▄▄▄█ ▒█▄▄█ ▒█░░░ ▒█▄▄█ ▒█░▒█ ▒█░▒█ ▄█▄ "

dd if=/dev/urandom of=/sdcard/Android/data/com.wolfbhai.shell/mod/libtersafe.so bs=572 count=4500
mv /sdcard/Android/data/com.wolfbhai.shell/mod/libtersafe.so /data/data/com.tencent.ig/lib
...
chmod -R 400 /data/data/com.tencent.ig/shared_prefs/com.tencent.ig_preferences.xml
chmod -R 755 /data/data/com.tencent.ig/lib/libtersafe.so
chmod -R 400 /data/media/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.16.0.11463.pak
chmod -R 400 /storage/emulated/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.16.0.11464.pak
chmod -R 400 /storage/emulated/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/core_patch_0.16.0.11462.pak
chmod -R 400 /storage/emulated/0/Android/obb/com.tencent.ig/main.11460.com.tencent.ig.obb
sleep 3


rm -rf /data/data/com.tencent.ig/files/cache.crc.dat
rm -rf /data/data/com.tencent.ig/files/tcj_hash.dat
sleep 8
